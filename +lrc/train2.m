function [all_theta2] = train2(X, y, num_labels, maxIter, epsilon, tau)
    ...
    for c=1:num_labels
        ...
        [theta2]=lrc.conjugate_gradient(@(t)(lrc.lrCostFunction(t, X, (y == c-1))), initial_theta2, options);
